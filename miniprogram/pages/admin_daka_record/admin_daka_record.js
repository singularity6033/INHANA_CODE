...
Page({
  ...
  getChoiceRecord(openid_record){
    wx.cloud.callFunction({
      name:"get_choice_record_admin",
      data: {openid_record}
    }).then(res=>{
      console.log(res)
      this.setData({
  ...
  getAudioRecord(openid_record){
    wx.cloud.callFunction({
      name:"get_audio_record_admin",
      data: {openid_record}
    }).then(res=>{
      console.log(res)
      this.setData({
  ...
  onLoad: function (options) {
    openid_record = wx.getStorageSync('openid_record')
    this.getChoiceRecord(openid_record)
    this.getAudioRecord(openid_record)
  },
